...
const lifeAreas = [
  { name: "Nutrition", score: 80, icon: Apple, path: "/app/nutrition", color: "#22C55E", trend: "+5" },
  { name: "Sleep", score: 65, icon: Moon, path: "/app/sleep", color: "#4DA3FF", trend: "-3" },
  { name: "Fitness", score: 70, icon: Dumbbell, path: "/app", color: "#F59E0B", trend: "+8" },
  { name: "Finances", score: 60, icon: DollarSign, path: "/app", color: "#22C55E", trend: "+2" },
  { name: "Goals", score: 85, icon: Target, path: "/app", color: "#4DA3FF", trend: "+12" },
];
